...
task_params.add_argument('--experiment', type=str, default='mydataset', choices=['permMNIST', 'splitMNIST','mydataset'])
...
train_params.add_argument('--lr', type=float, default=0.0001, help="learning rate")
...
def run(args):
    ...
    result_path=os.path.join('./precision_onEachTask',args.scenario,args.savepath)
    ...
    classes_per_task = 20
    config['classes'] = classes_per_task if scenario=='domain' else classes_per_task*args.tasks
    '''
